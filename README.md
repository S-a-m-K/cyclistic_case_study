...
For the analysis process "Share" I chose [Tableau](https://public.tableau.com/views/cyclistictypesofbikesusedbyriders/CyclisiticCaseStudy?:language=en-GB&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link).
